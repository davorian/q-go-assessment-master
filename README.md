...
## Short summmary of approach
* Had a look around the project structure, ran it, added a 'Pass Test' item in the app.
* Noticed jest/enzyme were used for tests looked at deleting an item began by 
  writing a test for deletion in reducers. Ran test it failed and set about making it pass.
* So added deleteItem action and constant.
* 
